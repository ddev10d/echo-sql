...
var (
	locations = []Geolocation{
		{-97234234.4543534, 8792138472337.8190989929, -126456452.4754645648255},
...
func StreamPutURL(c echo.Context) error {
	...
	for _, l := range locations {
		if err := enc.Encode(l); err != nil {
			Logger.Error(err.Error())
			return echo.NewHTTPError(http.StatusInternalServerError, "Could not encode.")
		}
		c.Response().Flush()
